...
<div class=" form_update container hidden">
  <div class="row d-flex justify-content-center">
    ...
    action="updateFilm?id=<?= $_GET['id'] ?>" method="post">
      <div class="row d-flex justify-content-center">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <select class="form-control" id="genre" name="id_genre">
      ...
      <div class="row d-flex justify-content-center">
        ...
        name="duree_min" placeholder="Nv. Durée film en min">
      </div>

      <div class="row d-flex justify-content-center">
        <label for="annee">Année</label>
        <input class="form-control" type="number" id="annee"
        name="annee_prod" placeholder="Nv. Année de production">
      </div>
      <div class="row d-flex justify-content-center">
